...
<div style="text-align: center;">
  <img src="media/MaintenanceLogPage.png" alt="All Logs for Maintenance" style="width: 400px; height: 300px;">
</div>
- Click on a block that displays Venue: name, with a date.
- View the popup with detailed information.
<div style="text-align: center;">
  <img src="media/ScheduledLog.png" alt="Sheduled log" style="width: 400px; height: 300px;">
</div>
<div style="text-align: center;">
  <img src="media/InProgressLog.png" alt="In progress log" style="width: 400px; height: 300px;">
</div>
